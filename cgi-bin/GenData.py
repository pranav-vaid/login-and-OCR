...
file=formdata['inputfileadd'].value
...
def main():
    ...
    imgContours, npaContours, npaHierarchy = cv2.findContours(imgThreshCopy,
                                                              # input image, make sure to use a copy since the function
                                                              #will modify this image in the course of finding contours
                                                              cv2.RETR_EXTERNAL,
    ...
    intClassifications = []
    # declare empty classifications list, this will be our list of how we are classifying our chars from user input,
    ...
    for npaContour in npaContours:                          # for each contour
        if cv2.contourArea(npaContour) > MIN_CONTOUR_AREA:          # if contour is big enough to consider
            ...
            cv2.imshow("training_characters.png", imgTrainingNumbers)
...
##    print("\n\ntraining complete !!\n")
    ...
    header("")
    redirectURL="../finalupload.php?r=yes"
