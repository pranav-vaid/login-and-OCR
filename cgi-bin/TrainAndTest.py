...
def main():
    ...
    imgTestingNumbers = cv2.imread(file)          # read in testing numbers image
    ...
    cv2.imshow("Recognized Data", imgTestingNumbers)        # show input image with green boxes drawn around found digits
    ...
    header("")
    redirectURL="../finalreco.php?s="+strFinalString+"&a="+str(m)+"&d="+str(n)
##    print("<p>Characters in the image are<br>"+strFinalString+"</p>")       # show the full string

##    print('<input type="hidden" name="data" value="'+strFinalString+'">')

    print('<head><meta http-equiv="refresh" content="0;url='+str(redirectURL)+'"/></head>')
    #rediirect to another page with recognized characters
